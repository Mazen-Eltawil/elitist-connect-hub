	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': {
						boxShadow: '0 0 15px 0 rgba(217, 187, 98, 0.5)'
					},
					'50%': {
						boxShadow: '0 0 25px 5px rgba(217, 187, 98, 0.7)'
					}
				}
			},
			animation: {
			...
			backgroundImage: {
				...
				'gold-gradient': 'linear-gradient(135deg, #D9BB62 0%, #E5CB7C 50%, #D9BB62 100%)',
			...
			boxShadow: {
				...
				'gold': '0 10px 30px -10px rgba(217, 187, 98, 0.3)'
			},
