...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-shine font-elegant font-light mb-4 animate-fade-in">
              Contact Us
            </h1>
            <p className="text-elitist-light/70 max-w-xl mx-auto text-sm md:text-base animate-fade-in" style={{ animationDelay: '200ms' }}>
      ...
      <section className="py-16 bg-elitist-dark-accent relative">
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-2xl md:text-3xl text-shine font-elegant font-light mb-4">
              Our Location
            </h2>
            <div className="flex items-center justify-center gap-2 text-elitist-light/70">
              <MapPin size={18} className="text-elitist-gold" />
              <p>Dubai, United Arab Emirates</p>
            </div>
          </div>
          
          <div className="premium-card p-1 overflow-hidden animate-fade-in" style={{ animationDelay: '200ms' }}>
