        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center text-center">
          <div className="flex flex-col items-center space-y-12 md:space-y-16">
            ...
            <div className="relative">
              <img src="/lovable-uploads/c87673ce-1ddd-4237-99f5-cbdead5700ad.png" alt="Elitist Links Logo" className="w-32 h-32 md:w-36 md:h-36 animate-float opacity-0" style={{
              animation: 'float 6s ease-in-out infinite, fadeIn 1.2s ease-out forwards',
              backgroundColor: '#1C1C1C',
              // Exact match with background
              borderRadius: '0.5rem',
              boxShadow: '0 10px 25px -10px rgba(217, 187, 98, 0.2)'
            }} />
              
              {/* Subtle gold shimmer overlay */}
              <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_65%,rgba(217,187,98,0.15)_75%,transparent_85%)] bg-[length:200%_200%] animate-shimmer rounded-lg" style={{
            ...
            <div className="overflow-hidden">
              <img src="/lovable-uploads/e79e941e-5a6f-4ac6-a188-72bc768cbc79.png" alt="Elitist Links" style={{
              animation: 'fadeInUp 1.2s ease-out 0.3s forwards',
              filter: 'drop-shadow(0 4px 12px rgba(217, 187, 98, 0.15))'
            }} className="h-16 md:h-20 opacity-0 transform translate-y-5 object-scale-down" />
            </div>
